...
st.markdown("Upload an image or take a picture using your camera to detect the ISL sign.")

# Cache the model so it doesn't load every time
@st.cache_resource
def load_model():
...
with tab1:
    ...
    if camera_image is not None:
        ...
        processed_img, labels = process_image(image)
